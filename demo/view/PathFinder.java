...
public class PathFinder {
	...
	public void demo() {
		...
		final AStarCostEvaluator evaluator3 = new AStarCostEvaluator();
		final XAStarPathAlgorithm pathAlgorithm3 = new XAStarPathAlgorithm();
		pathAlgorithm1.setEvaluator(evaluator3);
		final Canvas canvas3 = createCanvas(parameters, evaluator1);
		final CanvasPanel canvasPanel3 = new CanvasPanel("Teste", canvas3);
